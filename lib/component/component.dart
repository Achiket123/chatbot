...
class MessageField extends StatelessWidget {
  ...
  MessageField({super.key, this.controller, this.text,required this.buttonFunction});
     ...
     Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(onPressed: buttonFunction, icon:const Icon(Icons.file_copy,size: 20,))
        ],
      ),
    );
  }
